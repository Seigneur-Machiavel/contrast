export class ButtonHoldAnimation {
	/** @param {HTMLButtonElement} target @param {boolean} invertColors @param {number} duration */
	static holdMouseUp(target, invertColors = false, duration = 1000) {
	...
	/** @param {HTMLButtonElement} target @param {Function} callback @param {boolean} invertColors @param {number} duration */
	static holdMouseDown(target, callback, invertColors = false, duration = 2000) {
...
export const horizontalBtnLoading = 
