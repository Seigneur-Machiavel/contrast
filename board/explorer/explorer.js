...
export class Explorer {
	...
	#onConsensusHeightChange = async (newHeight = 0) => {
		...
		this.bc.createEmptyBlocksUntilFillTheDiv(); // FILL EMPTY SPACE WITH EMPTY BLOCKS.
		await new Promise(r => setTimeout(r, 1000));
		await this.#fillBlocksFromLastUntilEnough(t); // FILL PREVIOUS BLOCKS IF NEEDED (ENSURE CONSISTENCY)
